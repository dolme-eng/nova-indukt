  ...
  return (
    <footer data-testid="site-footer" className="bg-[#0C211E] text-white overflow-hidden relative border-t border-[#17423C]">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {features.map((feature, index) => (
              <div key={index} className="flex gap-2 group items-center">
                <div className="w-8 h-8 bg-[#17423C] rounded-lg flex items-center justify-center flex-shrink-0 border border-[#236456]">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-10 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-6">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="space-y-2 mb-6">
              ...
              >
                <div className="w-8 h-8 rounded-lg bg-[#25D366]/10 flex items-center justify-center border border-[#25D366]/20">
            ...
            <div className="flex gap-4">
              <a href={COMPANY.social.facebook} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 border border-transparent flex items-center justify-center text-gray-500 hover:bg-[#4ECCA3] hover:text-white transition-colors cursor-pointer" aria-label="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </a>
              <a href={COMPANY.social.instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 border border-transparent flex items-center justify-center text-gray-500 hover:bg-[#4ECCA3] hover:text-white transition-colors cursor-pointer" aria-label="Instagram">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        {/* Trust Badges */}
        <div className="border-t border-[#236456]/50 mt-4 pt-4">
          <div className="flex flex-wrap items-center justify-center gap-6 gap-y-2">
            {[
              { icon: <Lock className="w-3 h-3 text-[#4ECCA3]" />, label: 'SSL-Verschlüsselt' },
              { icon: <Flag className="w-3 h-3 text-[#4ECCA3]" />, label: 'Premium Qualität' },
              { icon: <CheckCircle className="w-3 h-3 text-[#4ECCA3]" />, label: '2 Jahre Garantie' },
              { icon: <Shield className="w-3 h-3 text-[#4ECCA3]" />, label: 'Sichere Zahlung' },
            ].map((badge) => (
              <div key={badge.label} className="flex items-center gap-2 text-[11px] font-bold text-[#9FE1CD]">
                <span className="bg-white/5 w-6 h-6 rounded-full flex items-center justify-center border border-white/5">{badge.icon}</span>
