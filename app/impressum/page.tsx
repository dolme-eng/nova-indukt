    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <div className="space-y-8 rounded-2xl bg-white p-8 shadow-sm">
          {/* Angaben gemäß § 5 TMG */}
          <section>
            <h2 className="mb-4 text-xl font-semibold text-gray-900">Angaben gemäß § 5 TMG</h2>
          ...
          {/* Vertreten durch */}
          <section>
            <h2 className="mb-4 text-xl font-semibold text-gray-900">Vertreten durch</h2>
          ...
          {/* Registereintrag */}
          <section>
            <h2 className="mb-4 text-xl font-semibold text-gray-900">Registereintrag</h2>
            <div className="space-y-2 text-gray-700">
          ...
          <section>
            <h2 className="mb-4 text-xl font-semibold text-gray-900">EU-Streitschlichtung</h2>
          ...
          {/* Haftung für Inhalte */}
          <section>
            <h2 className="mb-4 text-xl font-semibold text-gray-900">Haftung für Inhalte</h2>
            <p className="text-gray-700">
          ...
          {/* Haftung für Links */}
          <section>
            <h2 className="mb-4 text-xl font-semibold text-gray-900">Haftung für Links</h2>
            <p className="text-gray-700">
