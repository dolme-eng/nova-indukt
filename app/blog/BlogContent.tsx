      ...
      <div className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-4 py-8 sm:py-12">
          <div className="max-w-4xl mx-auto text-center">
            <Link 
              href="/" 
              className="hidden lg:inline-flex items-center gap-2 text-gray-500 hover:text-nova-700 transition-colors mb-6"
            >
              <ArrowLeft className="w-4 h-4" />
                  ...
                  <Link href={`/blog/${post.slug}`} className="block">
                    <div className="relative aspect-video overflow-hidden">
                      ...
                      <div className="absolute top-3 sm:top-4 left-3 sm:left-4">
                        <span className="px-2 sm:px-3 py-1 bg-[#4ECCA3] text-[#0C211E] text-xs font-bold rounded-full flex items-center gap-1">
                    ...
                    <div className="p-4 sm:p-6">
                      ...
                      <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 group-hover:text-nova-700 transition-colors line-clamp-2">
                        {post.title.de}
                      </h2>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="flex items-center gap-1 text-nova-700 font-medium text-xs sm:text-sm">
                          Weiterlesen
