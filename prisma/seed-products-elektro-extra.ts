...
const products = [
  {
    ...
    shortDescription:
      'Leistungsstarker Handmixer mit 400 Watt - 5 Geschwindigkeiten + Turbo-Funktion',
...
Der ideale Handmixer für ambitionierte Hobby-Köche.`,
...

  {
    ...
    shortDescription:
      'Edelstahl-Stabmixer mit 600 Watt - Made in Germany, spülmaschinengeeignetes Mixbecher',
