...
const products = [
...

  {
    ...
    shortDescription:
      'Langlebige Keramik-Antihaftbeschichtung - Zwilling-Qualität, spülmaschinengeeignet',
...
Erhältlich in mehreren Größen (20–32 cm) für das komplette Kochgeschirr-Set mit einem System.`,
    ...
    reviewCount: 0,
    metaTitle:
      'Berndes Vario Click Induction 28 cm - Bratpfanne mit abnehmbarem Griff | NOVA INDUKT',
    metaDescription:
...
Die Permadur Advance eignet sich besonders für Hobbyköche, die eine robustere Alternative zur Standardantihaft suchen.`,
    ...
    reviewCount: 0,
    metaTitle:
      'WMF Permadur Advance Bratpfanne 28 cm - Robuste Antihaft-Induktionspfanne | NOVA INDUKT',
    metaDescription:
...
SKK - seit über 60 Jahren Synonym für handgefertigtes Premium-Kochgeschirr aus dem Saarland.`,
...

  {
    ...
    shortDescription:
      'Ökologisch & nickelfrei - aus 100% recyceltem Aluminium, hergestellt in Deutschland',
...
Qualitätspfanne mit gutem Gewissen - die Öko-Wahl ohne Kompromisse bei der Leistung.`,
...

  {
    ...
    shortDescription:
      'Profipfanne ohne Beschichtung - perfekte Kruste für Steaks, Backofengeeignet',
...
Diese Pfanne wird mit jeder Nutzung besser - die Oberfläche entwickelt sich zur natürlichen Patina.`,
    ...
    reviewCount: 0,
    metaTitle:
      'Fissler Crispy Steelux Premium 24 cm - Edelstahl Profi-Induktionspfanne | NOVA INDUKT',
    metaDescription:
...
Von professionellen Köchen und Food-Kritikern weltweit als "die beste Bratpfanne" bezeichnet.`,
    ...
    reviewCount: 0,
    metaTitle:
      'Demeyere Proline 7 Bratpfanne 28 cm - Premium 7-lagige Induktionspfanne | NOVA INDUKT',
    metaDescription:
