...
Für alle, die ein zuverlässiges, handliches Messer für den täglichen Gebrauch suchen.`,
  ...
  },
  {
    ...
    shortDescription:
      'Handgeschliffenes Bunka-Messer mit MicroCarbide MC63 Stahl - made in Seki/Japan',
...
Regelmäßiges Abziehen mit dem Schärfstahl verlängert die Lebensdauer Ihres Messers erheblich.`,
    ...
    metaDescription:
      'Zwilling Twin Fin II Schärfstahl - Edelstahl, Made in Germany, für alle Messertypen. Jetzt bei NOVA INDUKT.',
    categorySlug: 'messer',
