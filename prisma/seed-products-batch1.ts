...
Die Beschichtung entwickelt mit der Zeit eine natürliche Patina, was ein Zeichen aktiver Nutzung und höchster Qualität ist.`,
    ...
    imageFiles: ['1.jpg', '2.jpg', '3.jpg', '4.jpeg'],
  },

  {
    ...
    shortDescription:
      'Leichtgewicht-Antihaftpfanne mit Thermo-Spot-Indikator - 3 L Fassungsvermögen',
...
Die abnehmbare Griff-Funktion (Nowo-System) ermöglicht platzsparendes Verstauen und direkten Backofeneinsatz.`,
    ...
    reviewCount: 0,
    metaTitle:
      'Woll Titanium Nowo 1528IL 28 cm - Induktionspfanne mit abnehmbarem Griff | NOVA INDUKT',
    metaDescription:
...

  {
    ...
    shortDescription:
      'Klassische Gusseisenpfanne mit Lifetime-Garantie - voreingebrannt & sofort einsatzbereit',
...
Eine Pfanne, die Generationen übersteht - je mehr sie benutzt wird, desto besser wird sie.`,
...

  {
    ...
    shortDescription:
      'Französische Gusseisenpfanne der Extraklasse - mattschwarze Emaille, Ofenfest',
...
Die fp30 ist mehr als eine Pfanne - sie ist ein Kochpartner für das ganze Leben.`,
...

  {
    ...
    shortDescription:
      'Testsieger-Wok mit Thermo-Spot - leicht, spülmaschinenfest, induktionsoptimiert',
...
Der ideale Wok für schnelle asiatische Gerichte auf dem Induktionsherd.`,
...

  {
    ...
    shortDescription:
      'Platz 1 Testberichte.de - 6 L Großraumwok mit Maßskala, hergestellt in Deutschland',
