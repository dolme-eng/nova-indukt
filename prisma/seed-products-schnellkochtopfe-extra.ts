...
const products = [
  {
    ...
    shortDescription:
      'Premium-Schnellkochtopf mit Sicomatic®-Verschluss - 8 Liter, hergestellt in Deutschland',
...
Mit 8 Litern Fassungsvermögen ideal für große Familien und Mahlzeiten für 6–8 Personen.`,
    ...
    reviewCount: 0,
    metaTitle:
      'Fissler vitavit edition Schnellkochtopf 8,0 L - Premium Druckkochtopf | NOVA INDUKT',
    metaDescription:
...
Das Duromatic Top 6,5 L vereint Schweizer Qualität mit großzügigem Fassungsvermögen für die gesamte Familie.`,
...

  {
    ...
    shortDescription:
      'Kompaktes Premium-Schnellkochtopf mit Sicomatic® - ideal für kleine Haushalte',
