...
const products = [
  {
    ...
    shortDescription:
      'Autarkes Einbau-Induktionskochfeld (60 cm) mit Bräterzone - Stiftung Warentest Testsieger (Note 2,0)',
...
Die perfekte Wahl für alle, die ein zuverlässiges, sicheres und langlebiges Induktionskochfeld in Markenqualität suchen.`,
  ...
  },
  {
    ...
    shortDescription:
      'Autarkes Premium-Induktionskochfeld (60 cm) mit varioInduction Plus & Bratsensor Plus',
...
Ein absolutes Highlight für anspruchsvolle Hobbyköche, die modernste Flexibilität und perfekte Brat-Ergebnisse suchen.`,
  ...
  },
  {
    ...
    shortDescription:
      'Rahmenloses 80 cm Induktionskochfeld - flächenbündig, Home Connect & Pastastufe',
...
Luxuriöses Design und viel Platz zum Kochen für große Familien und kulinarische Kreationen.`,
  ...
  },
  {
    ...
    shortDescription:
      'Luxus-Induktionskochfeld (80 cm) mit FlexInduction & magnetischer TwistPad-Bedienung',
...
Erleben Sie das intuitivste und spielerischste Kocherlebnis mit der legendären TwistPad-Steuerung von Neff.`,
  ...
  },
  {
    ...
    shortDescription:
      'Gigantisches 90 cm Premium-Kochfeld mit varioInduction Plus, Home Connect & Bratsensor',
