...
const baseProducts: Product[] = [
  ...
  // 44 — ZWILLING Plus Bratentopf 24cm
  {
    ...
    images: [
      p('zwilling-plus-topf', '1.png', 'kochen', 'ZWILLING Plus Bratentopf 24 cm – mit Glasdeckel, 4 L'),
      p('zwilling-plus-topf', '2.png', 'kochen', 'ZWILLING Plus Bratentopf 24 cm – mit Glasdeckel, 4 L'),
      p('zwilling-plus-topf', '3.png', 'kochen', 'ZWILLING Plus Bratentopf 24 cm – mit Glasdeckel, 4 L')
    ],
  ...
  // 49 — ZWILLING Marquina Plus Pfanne 28cm
  {
    ...
    images: [
      p('zwilling-marquina', '1.png', 'kochen', 'ZWILLING Marquina Plus Pfanne 28 cm – 4-Lagen Duraslide'),
      p('zwilling-marquina', '2.png', 'kochen', 'ZWILLING Marquina Plus Pfanne 28 cm – 4-Lagen Duraslide'),
      p('zwilling-marquina', '3.png', 'kochen', 'ZWILLING Marquina Plus Pfanne 28 cm – 4-Lagen Duraslide')
    ],
  ...
  // 50 — WMF Permadur Premium Pfanne 28cm
  {
    ...
    images: [
      p('wmf-permadur', '1.png', 'kochen', 'WMF Permadur Premium Pfanne 28 cm – Made in Germany'),
      p('wmf-permadur', '2.png', 'kochen', 'WMF Permadur Premium Pfanne 28 cm – Made in Germany'),
      p('wmf-permadur', '3.png', 'kochen', 'WMF Permadur Premium Pfanne 28 cm – Made in Germany')
    ],
  ...
  // 58 — WMF Provence Plus Kochtopf 20cm
  {
    ...
    category: 'kochen', price: 48.02, oldPrice: 49,
    images: [p('wmf-provence-plus-kochtopf-20cm', '1.png', 'kochen', 'WMF Provence Plus Kochtopf 20 cm – Cromargan® Edelstahl'),
          p('wmf-provence-plus-kochtopf-20cm', '2.png', 'kochen', 'WMF Provence Plus Kochtopf 20 cm – Cromargan® Edelstahl'),
          p('wmf-provence-plus-kochtopf-20cm', '3.png', 'kochen', 'WMF Provence Plus Kochtopf 20 cm – Cromargan® Edelstahl'),],
  ...
  // 62 — WMF Perfect RDS Schnellkochtopf 4,5L
  {
    ...
    category: 'kochen', price: 87.22, oldPrice: 89,
    images: [
      p('wmf-perfect', '1.png', 'kochen', 'WMF Perfect Schnellkochtopf 4,5 L – Klassiker'),
      p('wmf-perfect', '2.png', 'kochen', 'WMF Perfect Schnellkochtopf 4,5 L – Klassiker')
    ],
  ...
  // 68 — WMF Macao Wok 36cm
  {
    ...
    category: 'kochen', price: 77.42, oldPrice: 79,
    images: [p('wmf-macao-wok-36cm', '1.png', 'kochen', 'WMF Macao Wok 36 cm – Cromargan® mit Ablagerost'),
          p('wmf-macao-wok-36cm', '2.png', 'kochen', 'WMF Macao Wok 36 cm – Cromargan® mit Ablagerost'),],
  ...
  // 69 — ZWILLING Plus Wok 32cm
  {
    ...
    category: 'kochen', price: 87.22, oldPrice: 89,
    images: [p('zwilling-plus-wok-32cm', '1.png', 'kochen', 'ZWILLING Plus Wok 32 cm – 3-Schicht-Material'),
          p('zwilling-plus-wok-32cm', '2.png', 'kochen', 'ZWILLING Plus Wok 32 cm – 3-Schicht-Material'),
          p('zwilling-plus-wok-32cm', '3.png', 'kochen', 'ZWILLING Plus Wok 32 cm – 3-Schicht-Material'),],
  ...
  // 77 — WMF Profi Plus Pfannenwender
  {
    ...
    images: [p('wmf-profi-plus-pfannenwender', '1.png', 'zubehoer', 'WMF Profi Plus Pfannenwender 33 cm – Cromargan®'),
          p('wmf-profi-plus-pfannenwender', '2.png', 'zubehoer', 'WMF Profi Plus Pfannenwender 33 cm – Cromargan®'),
          p('wmf-profi-plus-pfannenwender', '3.png', 'zubehoer', 'WMF Profi Plus Pfannenwender 33 cm – Cromargan®'),],
  ...
  // 78 — ZWILLING Pro Schöpflöffel
  {
    ...
    images: [p('zwilling-pro-schoepfloeffel', '1.png', 'zubehoer', 'ZWILLING Pro Schöpflöffel – Edelstahl 18/10'),
          p('zwilling-pro-schoepfloeffel', '2.png', 'zubehoer', 'ZWILLING Pro Schöpflöffel – Edelstahl 18/10'),
          p('zwilling-pro-schoepfloeffel', '3.png', 'zubehoer', 'ZWILLING Pro Schöpflöffel – Edelstahl 18/10'),],
  ...
  // 80 — WMF Topfuntersetzer Silikon 2-teilig
  {
    ...
    images: [p('wmf-topfuntersetzer-silikon-2-teilig', '1.png', 'zubehoer', 'WMF Topfuntersetzer Silikon 2-teilig – Hitzebeständig'),
          p('wmf-topfuntersetzer-silikon-2-teilig', '2.png', 'zubehoer', 'WMF Topfuntersetzer Silikon 2-teilig – Hitzebeständig'),
          p('wmf-topfuntersetzer-silikon-2-teilig', '3.png', 'zubehoer', 'WMF Topfuntersetzer Silikon 2-teilig – Hitzebeständig'),],
  ...
  // 89 — Rösle Silence Bratentopf 24cm
  {
    ...
    category: 'kochen', price: 67.62, oldPrice: 69,
    images: [
      p('roesle-silence-topf', '1.png', 'kochen', 'Rösle Silence Bratentopf 24 cm – Edelstahl 18/10'),
      p('roesle-silence-topf', '2.png', 'kochen', 'Rösle Silence Bratentopf 24 cm – Edelstahl 18/10'),
      p('roesle-silence-topf', '3.png', 'kochen', 'Rösle Silence Bratentopf 24 cm – Edelstahl 18/10')
    ],
  ...
  // 91 — WMF Provence Plus Stielkasserolle 16cm
  {
    ...
    images: [p('wmf-provence-plus-stielkasserolle-16cm', '1.png', 'kochen', 'WMF Provence Plus Stielkasserolle 16 cm – Cromargan®'),
          p('wmf-provence-plus-stielkasserolle-16cm', '2.png', 'kochen', 'WMF Provence Plus Stielkasserolle 16 cm – Cromargan®'),
          p('wmf-provence-plus-stielkasserolle-16cm', '3.png', 'kochen', 'WMF Provence Plus Stielkasserolle 16 cm – Cromargan®'),],
  ...
  // 92 — ZWILLING Neo Stielkasserolle 16cm
  {
    ...
    category: 'kochen', price: 44.10, oldPrice: 45,
    images: [p('zwilling-neo-stielkasserolle-16cm', '1.png', 'kochen', 'ZWILLING Neo Stielkasserolle 16 cm – mattierter Edelstahl'),
          p('zwilling-neo-stielkasserolle-16cm', '2.png', 'kochen', 'ZWILLING Neo Stielkasserolle 16 cm – mattierter Edelstahl'),
          p('zwilling-neo-stielkasserolle-16cm', '3.png', 'kochen', 'ZWILLING Neo Stielkasserolle 16 cm – mattierter Edelstahl'),
          p('zwilling-neo-stielkasserolle-16cm', '4.png', 'kochen', 'ZWILLING Neo Stielkasserolle 16 cm – mattierter Edelstahl'),],
  ...
  // 95 — WMF Perfect Schnellkochtopf-Set 4,5L + 3,0L
  {
    ...
    category: 'kochen', price: 146.02, oldPrice: 149,
    images: [
      p('wmf-perfect-set', '1.png', 'kochen', 'WMF Perfect Schnellkochtopf-Set 2-teilig – 4,5 L + 3,0 L'),
      p('wmf-perfect-set', '2.png', 'kochen', 'WMF Perfect Schnellkochtopf-Set 2-teilig – 4,5 L + 3,0 L')
    ],
  ...
  // 98 — WMF Macao Wok 36cm
  {
    ...
    category: 'kochen', price: 77.42, oldPrice: 79,
    images: [
      p('wmf-macao-set', 'wmf-macao-wok-36cm-set-1.webp', 'kochen', 'WMF Macao Wok 36 cm – Cromargan® Edelstahl'),
      p('wmf-macao-set', 'wmf-macao-wok-36cm-set-2.webp', 'kochen', 'WMF Macao Wok 36 cm – Cromargan® Edelstahl')
    ],
  ...
  // 99 — ZWILLING Plus Wok 32cm
  {
    ...
    category: 'kochen', price: 87.22, oldPrice: 89,
    images: [p('zwilling-plus-wok-32cm-induktion', '1.png', 'kochen', 'ZWILLING Plus Wok 32 cm – SIGMA Clad 3-Schicht'),
          p('zwilling-plus-wok-32cm-induktion', '2.png', 'kochen', 'ZWILLING Plus Wok 32 cm – SIGMA Clad 3-Schicht'),
          p('zwilling-plus-wok-32cm-induktion', '3.png', 'kochen', 'ZWILLING Plus Wok 32 cm – SIGMA Clad 3-Schicht'),],
  ...
  // 104 — WMF Grillpfanne 27x27cm
  {
    ...
    category: 'kochen', price: 57.82, oldPrice: 59,
    images: [p('wmf-grillpfanne-quadratisch-27cm', '1.png', 'kochen', 'WMF Grillpfanne 27 x 27 cm – Cromargan®'),
          p('wmf-grillpfanne-quadratisch-27cm', '2.png', 'kochen', 'WMF Grillpfanne 27 x 27 cm – Cromargan®'),
          p('wmf-grillpfanne-quadratisch-27cm', '3.png', 'kochen', 'WMF Grillpfanne 27 x 27 cm – Cromargan®'),],
  ...
  // 107 — WMF Profi Plus Pfannenwender 33cm
  {
    ...
    category: 'zubehoer', price: 18.62, oldPrice: 19,
    images: [p('wmf-profi-plus-pfannenwender-edelstahl-33cm', '1.png', 'zubehoer', 'WMF Profi Plus Pfannenwender 33 cm – Edelstahl'),
          p('wmf-profi-plus-pfannenwender-edelstahl-33cm', '2.png', 'zubehoer', 'WMF Profi Plus Pfannenwender 33 cm – Edelstahl'),
          p('wmf-profi-plus-pfannenwender-edelstahl-33cm', '3.png', 'zubehoer', 'WMF Profi Plus Pfannenwender 33 cm – Edelstahl'),],
  ...
  // 108 — ZWILLING Pro Schöpflöffel
  {
    ...
    name: { de: 'ZWILLING Pro Schöpflöffel – Edelstahl 18/10' },
    category: 'zubehoer', price: 24.50, oldPrice: 25,
    images: [p('zwilling-pro-schoepfloeffel-edelstahl', '1.png', 'zubehoer', 'ZWILLING Pro Schöpflöffel – Edelstahl 18/10'),
          p('zwilling-pro-schoepfloeffel-edelstahl', '2.png', 'zubehoer', 'ZWILLING Pro Schöpflöffel – Edelstahl 18/10'),
          p('zwilling-pro-schoepfloeffel-edelstahl', '3.png', 'zubehoer', 'ZWILLING Pro Schöpflöffel – Edelstahl 18/10'),],
  ...
  // 112 — WMF Hello FUNctionals Dampfgareinsatz 24cm
  {
    ...
    category: 'zubehoer', price: 38.22, oldPrice: 39,
    images: [p('wmf-hello-functionals-dampfgareinsatz-24cm', '1.png', 'zubehoer', 'WMF Hello FUNctionals Dampfgareinsatz – Edelstahl'),
          p('wmf-hello-functionals-dampfgareinsatz-24cm', '2.png', 'zubehoer', 'WMF Hello FUNctionals Dampfgareinsatz – Edelstahl'),],
